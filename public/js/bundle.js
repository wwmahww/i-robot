...
var funs = _interopRequireWildcard(require("./funs"));
...
// DOM ELEMENTS
var input = (0, _jquery.default)('.validate-input .input100'); // VALUES

var showPass = 0; // functions

var getBotData = function getBotData() {
  var bot = {};
  bot.timeLeft = timeLimit;
  bot.pageName = (0, _jquery.default)('input[name="pageName"]').val();
  bot.pagePassword = (0, _jquery.default)('input[name="pagePassword"]').val();
  bot.botPace = (0, _jquery.default)('#botpace').text();
  bot.followPrivate = (0, _jquery.default)('#followPrivate').prop('checked');
  bot.likeLastPost = (0, _jquery.default)('#likeLastPost').prop('checked');
  bot.targetPages = (0, _jquery.default)('textarea[name="targetPages"]').val().split(' ').filter(function (el) {
    if (el !== ' ') return el;
  });
  bot.targetTags = (0, _jquery.default)('textarea[name="targetTags"]').val().split(' ').filter(function (el) {
    if (el !== ' ') return el;
  });
  bot.comments = (0, _jquery.default)('textarea[name="comments"]').val().split('*').filter(function (el) {
    if (el !== ' ') return el;
  });
  bot.directTexts = (0, _jquery.default)('textarea[name="directTexts"]').val().split('*').filter(function (el) {
    if (el !== ' ') return el;
  });
  bot.whiteList = (0, _jquery.default)('textarea[name="whitelist"]').val().split(' ').filter(function (el) {
    if (el !== ' ') return el;
  });
  return bot;
}; // DELEGATION
...
(0, _jquery.default)('.input100').each(function () {
  (0, _jquery.default)(this).on('blur', function () {
    if ((0, _jquery.default)(this).val().trim() != '') {
      (0, _jquery.default)(this).addClass('has-val');
    } else {
      (0, _jquery.default)(this).removeClass('has-val');
    }
  });
});
(0, _jquery.default)('.dropdown-menu').on('click', 'a', function () {
  console.log('clicked');
  (0, _jquery.default)('#dropdownMenuButton').text((0, _jquery.default)(this).text());
  (0, _jquery.default)('#dropdownMenuButton').val((0, _jquery.default)(this).text());
});
/*==================================================================
    [ Validate ]*/

(0, _jquery.default)('.validate-form').on('submit', function () {
  var check = true;
...
(0, _jquery.default)('.validate-form .input100').each(function () {
...
(0, _jquery.default)('.btn-show-pass').on('click', function () {
  if (showPass == 0) {
    (0, _jquery.default)(this).next('input').attr('type', 'text');
    (0, _jquery.default)(this).addClass('active');
    showPass = 1;
  } else {
    (0, _jquery.default)(this).next('input').attr('type', 'password');
...
(0, _jquery.default)('#signup').click(function (e) {
  e.preventDefault();
...
(0, _jquery.default)('#signin').click(function (e) {
  e.preventDefault();
...
(0, _jquery.default)('#trigger').on('click', function (e) {
  ...
  (0, _jquery.default)('#trigger  .rotator').show();
  var act = (0, _jquery.default)('#trigger').attr('name');
  var pageName = (0, _jquery.default)('h1').text();
  act === 'start' ? funs.botStart(pageName) : funs.botStop(pageName);
});
/*==================================================================
    [ new bot ]*/

(0, _jquery.default)('#newbot').click(function (e) {
  e.preventDefault();
  (0, _jquery.default)('#newbot').prop('disabled', true);
  (0, _jquery.default)('#newbot .rotator').show();
  var bot = getBotData();
  funs.newbot(bot);
});
/*==================================================================
...
(0, _jquery.default)('#updatebot').click(function (e) {
  e.preventDefault();
  (0, _jquery.default)('#updatebot').prop('disabled', true);
  (0, _jquery.default)('#updatebot .rotator').show();
  console.log('clicked');
  var id = (0, _jquery.default)('input[name="pageName"]').val();
  var bot = getBotData();
...
(0, _jquery.default)('#discountCheck').click(function (e) {
  e.preventDefault();
  (0, _jquery.default)('#discountCheck').prop('disabled', true);
  (0, _jquery.default)('#discountCheck .rotator').show();
...
(0, _jquery.default)('#pay').click(function (e) {
  e.preventDefault();
  (0, _jquery.default)('#pay').prop('disabled', true);
  e.target.textContent = '. . . درحال انتقال';
  console.log('code: ', service);
  console.log('code type: ', _typeof(service.code));
  funs.pay(service.code);
});
/*==================================================================
    [ Extension ]*/

(0, _jquery.default)('.extension').click(function (e) {
  e.preventDefault();
  var serviceCode = e.target.name;
  var botPagename = bot.pageName;
